...
public class SysSmsLogServiceImpl implements SysSmsLogService {
    ...
    @Override
    public int quertTotral(Map<String, Object> map) {
        return smsLogDao.queryTotal(map);
    }

    @Override
    public int save(SysSmsLogEntity sysSmsLogEntity) {
        sysSmsLogEntity.setId(IdUtil.createIdbyUUID());
        return smsLogDao.save(sysSmsLogEntity);
    }

    @Override
    public int update(SysSmsLogEntity sysSmsLogEntity) {
        return smsLogDao.update(sysSmsLogEntity);
    }
