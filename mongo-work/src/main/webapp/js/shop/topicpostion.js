...
var vm = new Vue({
    ...
    methods: {
        ...
        saveOrUpdate: function (event) {
            var url = vm.adPosition.id == null ? "../topicposition/save" : "../topicposition/update";
            $.ajax({
                type: "POST",
                url: url,
        ...
        getInfo: function (id) {
            $.get("../topicposition/info/" + id, function (r) {
