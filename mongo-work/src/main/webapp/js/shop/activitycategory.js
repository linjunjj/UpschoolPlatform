...
function getGrid() {
    ...
    var table = new TreeTable(TreeGrid.id, '../activitycategory/queryAll', colunms);
...
var vm = new Vue({
    ...
    methods: {
        ...
        getParentCategory: function () {
            $.get("../activitycategory/getCategorySelect", function (r) {
                vm.categoryList = r.list;
            });
        },
        saveOrUpdate: function (event) {
            var url = vm.category.id == null ? "../activitycategory/save" : "../activitycategory/update";
            $.ajax({
                type: "POST",
                url: url,
        ...
        getInfo: function (id) {
            $.get("../activitycategory/info/" + id, function (r) {
