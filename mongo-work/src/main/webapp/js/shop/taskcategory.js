...
function getGrid() {
    ...
    var table = new TreeTable(TreeGrid.id, '../taskcategory/queryAll', colunms);
...
var vm = new Vue({
    ...
    methods: {
        ...
        getParentCategory: function () {
            $.get("../taskcategory/getCategorySelect", function (r) {
                vm.categoryList = r.list;
            });
        },
        saveOrUpdate: function (event) {
            var url = vm.category.id == null ? "../taskcategory/save" : "../taskcategory/update";
            $.ajax({
                type: "POST",
                url: url,
        ...
        getInfo: function (id) {
            $.get("../taskcategory/info/" + id, function (r) {
