...
function getGrid() {
    ...
    var table = new TreeTable(TreeGrid.id, '../skillcategory/queryAll', colunms);
...
var vm = new Vue({
    ...
    methods: {
        ...
        getParentCategory: function () {
            $.get("../skillcategory/getCategorySelect", function (r) {
                vm.categoryList = r.list;
            });
        },
        saveOrUpdate: function (event) {
            var url = vm.category.id == null ? "../skillcategory/save" : "../skillcategory/update";
            $.ajax({
                type: "POST",
                url: url,
        ...
        getInfo: function (id) {
            $.get("../skillcategory/info/" + id, function (r) {
