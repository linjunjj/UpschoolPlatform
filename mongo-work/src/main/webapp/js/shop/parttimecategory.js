...
function getGrid() {
    ...
    var table = new TreeTable(TreeGrid.id, '../parttimecategory/queryAll', colunms);
...
var vm = new Vue({
    ...
    methods: {
        ...
        getParentCategory: function () {
            $.get("../parttimecategory/getCategorySelect", function (r) {
                vm.categoryList = r.list;
            });
        },
        saveOrUpdate: function (event) {
            var url = vm.category.id == null ? "../parttimecategory/save" : "../parttimecategory/update";
            $.ajax({
                type: "POST",
                url: url,
        ...
        getInfo: function (id) {
            $.get("../parttimecategory/info/" + id, function (r) {
