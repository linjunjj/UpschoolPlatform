...
function getGrid() {
    ...
    var table = new TreeTable(TreeGrid.id, '../idlecategory/queryAll', colunms);
...
var vm = new Vue({
    ...
    methods: {
        ...
        getParentCategory: function () {
            $.get("../rentcategory/getCategorySelect", function (r) {
                vm.categoryList = r.list;
            });
        },
        saveOrUpdate: function (event) {
            var url = vm.category.id == null ? "../idlecategory/save" : "../idlecategory/update";
            $.ajax({
                type: "POST",
                url: url,
        ...
        getInfo: function (id) {
            $.get("../idlecategory/info/" + id, function (r) {
