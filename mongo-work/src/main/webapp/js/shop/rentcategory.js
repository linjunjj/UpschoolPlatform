...
function getGrid() {
    ...
    var table = new TreeTable(TreeGrid.id, '../rentcategory/queryAll', colunms);
...
var vm = new Vue({
    ...
    methods: {
        ...
        saveOrUpdate: function (event) {
            var url = vm.category.id == null ? "../rentcategory/save" : "../rentcategory/update";
            $.ajax({
                type: "POST",
                url: url,
        ...
        getInfo: function (id) {
            $.get("../rentcategory/info/" + id, function (r) {
