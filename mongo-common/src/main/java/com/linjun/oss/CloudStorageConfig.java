...
import com.linjun.validator.group.BaiduGroup;
...
//    百度云对象存储
    @NotNull(message = "百度云绑定的域名不能为空",groups = BaiduGroup.class)
   @URL(message = "百度绑定的域名格式不正确",groups = BaiduGroup.class)
     private  String  baiduDomain;
//    百度域名前缀
    private  String baiduPrefix;
//    百度ACCESS_KEY
    @NotNull(message = "百度AccessKey不能为空",groups =BaiduGroup.class)
    private  String baiduAccessKey;
//    百度SECRENT_KEY
    @NotNull(message = "百度secrentKey不能为空",groups = BaiduGroup.class)
private  String baiduSecretKey;
//     百度 用户指定的ENDPOINT
    @NotNull(message = "百度ENDPOINT不能为空",groups = BaiduGroup.class)
